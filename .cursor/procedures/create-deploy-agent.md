...
3. Read `templates/domain/DEPLOY-AGENT-TEMPLATE.md`
...
Update the selected domain's `tree` in `.factory-state.json` to include the new deploy agent node under the appropriate parent.
